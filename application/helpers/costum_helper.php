 ...
 */
    ...
    function is_adminOprator() {
        ...
        elseif ($CI->session->userdata('role_id') != 1 && $CI->session->userdata('role_id') != 3) {
            redirect('page/access_denied');
        }
    ...
    function is_adminOpratorGuru() {
        ...
        elseif ($CI->session->userdata('role_id') != 1 && $CI->session->userdata('role_id') != 3 && $CI->session->userdata('role_id') != 4) {
            redirect('page/access_denied');
        }
