            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table style="font-size: 14px" id="datatable-aktivitas" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th width="50px">#</th>
    ...
    <script>
      $(document).ready(function () {
        $("#datatable-aktivitas").DataTable({
          ...
          "order": [], 
          "ajax": {
              "url": "<?= base_url('history/get_aktivitas') ?>",
              "type": "POST"
          },
          "language": {
