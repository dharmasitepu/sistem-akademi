                ...
                <div style="height: 600px" class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><label>Format Import ? </label> - <a
                                    href="<?= base_url('Export/fullSiswa/format') ?>">Klik Disini</a>
                            </p>
                            <form method="post" action="<?= base_url('importSiswa/import') ?>"
                                ...
                                <button type="submit" name="import" value="Import" id="import"
