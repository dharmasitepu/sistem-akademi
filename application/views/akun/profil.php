        ...
        <div class="">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <button data-toggle="modal" data-target="#changePass" class="btn btn-warning"><i class="fa fa-edit"></i> Ganti Password</button>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                  <?= form_open_multipart('profil_akun/update'); ?>
         ...
         <div id="changePass" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true" style="margin-top: 20vh">
          <div class="modal-dialog modal-sm">
            ...
            <?= form_open_multipart('Profil_akun/changePass'); ?>
